...
namespace Aoeng\Laravel\HuoBi\Api\Linear;
...
class Trade extends Huobi
{
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_batchorder';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_order_detail';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_lightning_close_position';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_trigger_order';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_trigger_cancel';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_trigger_cancelall';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_trigger_openorders';
    ...
    {
        $this->type = 'POST';
        $this->path = '/linear-swap-api/v1/swap_trigger_hisorders';
